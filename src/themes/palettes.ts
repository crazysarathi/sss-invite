 ...
 *
 * The hosts asked for pastels: pink shades, ivory shades, or a lighter
 * version of the Smashers' logo green & blue. Each ask gets two takes, so
...
export type PaletteId = "blush" | "rose" | "ivory" | "linen" | "sky" | "sage";
